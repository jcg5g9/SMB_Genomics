...
##### 1b.1. Read in sample metadata and generate lists of populations for all genome scan levesl.

###### 1b.1.1 Generate population file for all black bass samples:
...
load("../population_analysis/data/metadata/metadata_populations.Rda")

# Rename population designations in SPID format ("pop_1", "pop_2", etc.)
metadata_populations$population[metadata_populations$population == "MIDARK"] <- "pop_1"
metadata_populations$population[metadata_populations$population == "MISS"] <- "pop_2"
metadata_populations$population[metadata_populations$population == "SKIA"] <- "pop_3"
metadata_populations$population[metadata_populations$population == "LMULB"] <- "pop_4"
metadata_populations$population[metadata_populations$population == "WHITE"] <- "pop_5"
metadata_populations$population[metadata_populations$population == "ELK"] <- "pop_6"
metadata_populations$population[metadata_populations$population == "ILLI"] <- "pop_7"
metadata_populations$population[metadata_populations$population == "UPPARK"] <- "pop_8"
metadata_populations$population[metadata_populations$population == "BAYOU"] <- "pop_9"
metadata_populations$population[metadata_populations$population == "SPB"] <- "pop_10"
...
#### 1a: Generate a general bash shell script header for all PGDSPIDER conversion commands
