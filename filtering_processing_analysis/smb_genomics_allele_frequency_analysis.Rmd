...
## Specific Aim: Allele frequency analysis
In this analysis, we 
...
In this step, we are generating the header for a universal shell script 

### STEP 1: Filter SNPs for a minimum average depth of coverage of 15X
...
#### 1a: Generate a bash shell script to run VCFTOOLS to filter for mean depth of coverage; run the Rmd chunk below:

##### Bash shell script for VCFTools
```{bash}
#! /bin/bash
