...
### STEP 2: Filter SNPs for a minimum average depth of coverage of 15X
In this step, we are filtering the dataset to retain only SNPs that have a minimum average depth of coverage across all individuals of 15X. 

#### 2a: Include the code below in the vctools.sh shell script to filter for minimum average depth of coverage:
