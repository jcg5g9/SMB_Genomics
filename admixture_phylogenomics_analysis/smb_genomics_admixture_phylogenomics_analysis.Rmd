...
### IMPORTANT NOTE: We are using this dataset (fully filtered, thinned, excluding the Spotted Bass hybrid) for all further population genomic analyses. All subsequent analyses should begin by copying this vcf into the new directory: `admixture_phylogenomics_analysis/data/processed_vcf/popgen_spb_hybrid.vcf`
