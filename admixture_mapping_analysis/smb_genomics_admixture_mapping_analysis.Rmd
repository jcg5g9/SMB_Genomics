...
###### 4b.1.1: Copy and paste the code below in a new shell script file:
...
##### 4b.4. Copy and paste the code below in the shell file generated in Step 4b.1.1 above, which will generate .eigenstratgeno, .snp, and .ind files for the full dataset:

##### Command line code for geenrating .eigenstrat. UNCOMMENT this code in the shell script:
```{bash}
