...
### STEP 2: Install MCR runtime compiler (for running MATLAB if it is not installed on your local computer) and compile wrapper functions in MIXMAPPER software.
In this step, we are installing and compiling all necessary software and wrapper functions for MIXMAPPER
