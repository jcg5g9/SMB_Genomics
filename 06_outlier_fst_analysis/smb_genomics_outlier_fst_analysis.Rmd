---
title: 'Analysis 6: Directional selection inference'
author: "Joe Gunn"
date: "2022-09-03"
...
## PHASE 1: DATA PREPARATION
In this phase of the analysis, we are converting the fully filtered, thinned dataset excluding Spotted Bass and the Spotted Bass hybrid (`03_admixture_phylogenomics_analysis/data/processed_vcf/03_popgen_spb.vcf`) into input files compatible with the software programs BAYESCAN and the R package PCAdapt. For BAYESCAN, we are using the intermediate conversion software PGDSPIDER to generate input files, and for PCAdapt, we are again using the program PLINK.
...
metadata_populations_spb$population <- factor(with(metadata_populations_spb, ifelse(population=="MIDARK", "pop_1",
                                                                                    ifelse(population=="MISS", "pop_2",
                                                                                           ifelse(population=="SKIA", "pop_3",
                                                                                                  ifelse(population=="LMULB", "pop_4",
                                                                                                         ifelse(population=="WHITE", "pop_5",
                                                                                                                ifelse(population=="ELK", "pop_6",
                                                                                                                       ifelse(population=="ILLI", "pop_7",
                                                                                                                              ifelse(population=="UPPARK", "pop_8",
                                                                                                                                     ifelse(population=="BAYOU", "pop_9",
                                                                                                                                            ifelse(population=="SPB", "pop_10","done"))))))))))))
...
# Rename population designations in SPID format ("pop_1", "pop_2", etc.)
metadata_populations_complex$population <- factor(with(metadata_populations_complex, ifelse(population=="MIDARK", "pop_1",
                                                                                            ifelse(population=="MISS", "pop_2",
                                                                                                   ifelse(population=="SKIA", "pop_3",
                                                                                                          ifelse(population=="LMULB", "pop_4",
                                                                                                                 ifelse(population=="WHITE", "pop_5",
                                                                                                                        ifelse(population=="ELK", "pop_6",
                                                                                                                               ifelse(population=="ILLI", "pop_7",
                                                                                                                                      ifelse(population=="UPPARK", "pop_8",
                                                                                                                                             ifelse(population=="BAYOU", "pop_9","done")))))))))))
...
# Rename population designations in SPID format ("pop_1", "pop_2", etc.)
metadata_populations_neosho$population <- factor(with(metadata_populations_neosho, ifelse(population=="MIDARK", "pop_1",
                                                                                          ifelse(population=="LMULB", "pop_2",
                                                                                                 ifelse(population=="ELK", "pop_3",
                                                                                                        ifelse(population=="ILLI", "pop_4",
                                                                                                               ifelse(population=="UPPARK", "pop_5",
                                                                                                                      ifelse(population=="BAYOU", "pop_6","done"))))))))
...
# Rename population designations in SPID format ("pop_1", "pop_2", etc.)
metadata_populations_smallmouth$population <- factor(with(metadata_populations_smallmouth, ifelse(population=="WHITE", "pop_1",
                                                                                                   ifelse(population=="MISS", "pop_2",
                                                                                                          ifelse(population=="SKIA", "pop_3","done")))))
...
#### 2a. Generate metadata for SNP ID (RAD_kmer_...) and SNP position (nucleotide position on the kmer)
...
##### 2a.1. Generate SNP position and metadata; run the Rmd chunk below:
...
# Save SNP metadata
save(metadata_snps, file = "data/metadata/metadata_snps.Rda")
```
...
##### 2b.1: Read in Fst results for all samples and identify significant SNPs; run the Rmd chunk below.

##### Read in Fst results for all analyses:
```{r}
# Load SNP metadata
load("data/metadata/metadata_snps.Rda")
...
# Save species complex significance data
save(all_significant_bayescan, file = "data/bayescan_output/all_significant_bayescan.Rda")
save(all_not_significant_bayescan, file = "data/bayescan_output/all_not_significant_bayescan.Rda")

# combine data into one dataframe
all_fst <- rbind(all_significant_bayescan, all_not_significant_bayescan)

# Save all fst data
save(all_fst, file = "data/fst_data/all_fst.Rda")
```

##### 2b.2: Read in Fst results for species complex samples and identify significant SNPs; run the Rmd chunk below.

##### Read in Fst results for species complex analyses:
```{r}
# Load SNP metadata
load("data/metadata/metadata_snps.Rda")
...
# Save species complex significance data
save(species_complex_significant_bayescan, file = "data/bayescan_output/species_complex_significant_bayescan.Rda")
save(species_complex_not_significant_bayescan, file = "data/bayescan_output/species_complex_not_significant_bayescan.Rda")

#combine data into one dataframe
species_complex_fst <- rbind(species_complex_significant_bayescan, species_complex_not_significant_bayescan)

# Save species complex fst data
save(species_complex_fst, file = "data/fst_data/species_complex_fst.Rda")
```

##### 2b.3: Read in Fst results for Neosho samples and identify significant SNPs; run the Rmd chunk below.

##### Read in Fst results for Neosho samples:
```{r}
# Load SNP metadata
load("data/metadata/metadata_snps.Rda")
...
# Save Neosho significance data
save(neosho_significant_bayescan, file = "data/bayescan_output/neosho_significant_bayescan.Rda")
save(neosho_not_significant_bayescan, file = "data/bayescan_output/neosho_not_significant_bayescan.Rda")

#combine data into one dataframe
neosho_fst <- rbind(neosho_significant_bayescan, neosho_not_significant_bayescan)
  
# Save Neosho fst data
save(neosho_fst, file = "data/fst_data/neosho_fst.Rda")
```

##### 2b.4: Read in Fst results for Smallmouth samples and identify significant SNPs; run the Rmd chunk below.

##### Read in Fst results for Smallmouth samples:
```{r}
# Load SNP metadata
load("data/metadata/metadata_snps.Rda")
...
# Save Smallmouth significance data
save(smallmouth_significant_bayescan, file = "data/bayescan_output/smallmouth_significant_bayescan.Rda")
save(smallmouth_not_significant_bayescan, file = "data/bayescan_output/smallmouth_not_significant_bayescan.Rda")

#combine data into one dataframe
smallmouth_fst <- rbind(smallmouth_significant_bayescan, smallmouth_not_significant_bayescan)

# Save Smallmouth fst data
save(smallmouth_fst, file = "data/fst_data/smallmouth_fst.Rda")
```
...
```{r}
# Load all fst data
load("data/fst_data/all_fst.Rda")
load("data/fst_data/species_complex_fst.Rda")
load("data/fst_data/neosho_fst.Rda")
load("data/fst_data/smallmouth_fst.Rda")
...
# Save all clean data
save(all_clean, file = "data/fst_data/all_clean.Rda")
save(species_complex_clean, file = "data/fst_data/species_complex_clean.Rda")
save(neosho_clean, file = "data/fst_data/neosho_clean.Rda")
save(smallmouth_clean, file = "data/fst_data/smallmouth_clean.Rda")
```
...
```{r}
# Load all clean st data
load("data/fst_data/all_clean.Rda")
load("data/fst_data/species_complex_clean.Rda")
load("data/fst_data/neosho_clean.Rda")
load("data/fst_data/smallmouth_clean.Rda")
...
# Save formatted bed files
save(all_bed, file = "data/processed_bed/all_bed.Rda")
save(species_complex_bed, file = "data/processed_bed/species_complex_bed.Rda")
save(neosho_bed, file = "data/processed_bed/neosho_bed.Rda")
save(smallmouth_bed, file = "data/processed_bed/smallmouth_bed.Rda")
```
...
```{r}
# Load bed files
load("data/processed_bed/all_bed.Rda")
load("data/processed_bed/species_complex_bed.Rda")
load("data/processed_bed/neosho_bed.Rda")
load("data/processed_bed/smallmouth_bed.Rda")
...
# Save PCAdapt output
save(all_pca_k20, file = "data/pcadapt_output/all_pca_k20.Rda")
save(species_complex_pca_k20, file = "data/pcadapt_output/species_complex_pca_k20.Rda")
save(neosho_pca_k20, file = "data/pcadapt_output/neosho_pca_k20.Rda")
save(smallmouth_pca_k20, file = "data/pcadapt_output/smallmouth_pca_k20.Rda")
```
...
```{r}
# Load PCAdapt output
load("data/pcadapt_output/all_pca_k20.Rda")
load("data/pcadapt_output/species_complex_pca_k20.Rda")
load("data/pcadapt_output/neosho_pca_k20.Rda")
load("data/pcadapt_output/smallmouth_pca_k20.Rda")
...
# Save PCAdapt output
save(all_pca_variance_k20, file = "data/pcadapt_output/all_pca_variance_k20.Rda")
save(species_complex_pca_variance_k20, file = "data/pcadapt_output/species_complex_pca_variance_k20.Rda")
save(neosho_pca_variance_k20, file = "data/pcadapt_output/neosho_pca_variance_k20.Rda")
save(smallmouth_pca_variance_k20, file = "data/pcadapt_output/smallmouth_pca_variance_k20.Rda")
```
...
```{r}
# Save PCAdapt output
load("data/pcadapt_output/all_pca_variance_k20.Rda")
load("data/pcadapt_output/species_complex_pca_variance_k20.Rda")
load("data/pcadapt_output/neosho_pca_variance_k20.Rda")
load("data/pcadapt_output/smallmouth_pca_variance_k20.Rda")
...
# Save PCAdapt output
save(all_pca_k2, file = "data/pcadapt_output/all_pca_k2.Rda")
save(species_complex_pca_k2, file = "data/pcadapt_output/species_complex_pca_k2.Rda")
save(neosho_pca_k4, file = "data/pcadapt_output/neosho_pca_k4.Rda")
save(smallmouth_pca_k3, file = "data/pcadapt_output/smallmouth_pca_k3.Rda")
```
...
```{r}
# Load PCAdapt output
load("data/pcadapt_output/all_pca_k2.Rda")
load("data/pcadapt_output/species_complex_pca_k2.Rda")
load("data/pcadapt_output/neosho_pca_k4.Rda")
load("data/pcadapt_output/smallmouth_pca_k3.Rda")
...
# Save all significance data
save(all_significant_pcadapt, file = "data/pcadapt_output/all_significant_pcadapt.Rda")
save(all_not_significant_pcadapt, file = "data/pcadapt_output/all_not_significant_pcadapt.Rda")
```
...
# Save species_complex significance data
save(species_complex_significant_pcadapt, file = "data/pcadapt_output/species_complex_significant_pcadapt.Rda")
save(species_complex_not_significant_pcadapt, file = "data/pcadapt_output/species_complex_not_significant_pcadapt.Rda")
```
...
# Save neosho significance data
save(neosho_significant_pcadapt, file = "data/pcadapt_output/neosho_significant_pcadapt.Rda")
save(neosho_not_significant_pcadapt, file = "data/pcadapt_output/neosho_not_significant_pcadapt.Rda")
```
...
# Save Smallmouth significance data
save(smallmouth_significant_pcadapt, file = "data/pcadapt_output/smallmouth_significant_pcadapt.Rda")
save(smallmouth_not_significant_pcadapt, file = "data/pcadapt_output/smallmouth_not_significant_pcadapt.Rda")
```
...
```{r}
# Load bayescan significance data for all samples
load("data/bayescan_output/all_significant_bayescan.Rda")
load("data/bayescan_output/all_not_significant_bayescan.Rda")

# Load pcadapt significance data for all samples
load("data/pcadapt_output/smallmouth_significant_pcadapt.Rda")
load("data/pcadapt_output/smallmouth_not_significant_pcadapt.Rda")
...
```{r}
# Load bayescan significance data for species_complex samples
load("data/bayescan_output/species_complex_significant_bayescan.Rda")
load("data/bayescan_output/species_complex_not_significant_bayescan.Rda")

# Load pcadapt significance data for species_complex samples
load("data/pcadapt_output/smspecies_complexmouth_significant_pcadapt.Rda")
load("data/pcadapt_output/smspecies_complexmouth_not_significant_pcadapt.Rda")
...
```{r}
# Load bayescan significance data for neosho samples
load("data/bayescan_output/neosho_significant_bayescan.Rda")
load("data/bayescan_output/neosho_not_significant_bayescan.Rda")

# Load pcadapt significance data for neosho samples
load("data/pcadapt_output/smneoshomouth_significant_pcadapt.Rda")
load("data/pcadapt_output/smneoshomouth_not_significant_pcadapt.Rda")
...
```{r}
# Load bayescan significance data for smallmouth samples
load("data/bayescan_output/smallmouth_significant_bayescan.Rda")
load("data/bayescan_output/smallmouth_not_significant_bayescan.Rda")

# Load pcadapt significance data for smallmouth samples
load("data/pcadapt_output/smsmallmouthmouth_significant_pcadapt.Rda")
load("data/pcadapt_output/smsmallmouthmouth_not_significant_pcadapt.Rda")
...
# Save formatted vcfs for downstream analyses
save(all_outliers, file = "data/processed_Rda/all_outliers.Rda")
save(all_neutral, file = "data/processed_Rda/all_neutral.Rda")
...
# Save formatted Rdas for downstream analyses
save(species_complex_outliers, file = "data/processed_Rda/species_complex_outliers.Rda")
save(species_complex_neutral, file = "data/processed_Rda/species_complex_neutral.Rda")
...
# Save formatted Rdas for downstream analyses
save(neosho_outliers, file = "data/processed_Rda/neosho_outliers.Rda")
save(neosho_neutral, file = "data/processed_Rda/neosho_neutral.Rda")
...
# Save formatted vcfs for downstream analyses
save(smallmouth_outliers, file = "data/processed_Rda/smallmouth_outliers.Rda")
save(smallmouth_neutral, file = "data/processed_Rda/smallmouth_neutral.Rda")
```

##### 3a.2. Convert VCF files to genind objects, which are the preferred input type for DAPC, and include population designations in the object. Scale genind objects; run the Rmd chunk below:
...
```{r}
# Load all vcf files
load("data/processed_Rda/all_outliers.Rda")
load("data/processed_Rda/all_neutral.Rda")
load("data/processed_Rda/species_complex_outliers.Rda")
load("data/processed_Rda/species_complex_neutral.Rda")
load("data/processed_Rda/neosho_outliers.Rda")
load("data/processed_Rda/neosho_neutral.Rda")
load("data/processed_Rda/smallmouth_outliers.Rda")
load("data/processed_Rda/smallmouth_neutral.Rda")
...
# Save all genind files
save(all_neutral_genind, file = "data/genind_files/all_neutral_genind.Rda")
save(species_complex_outliers_genind, file = "data/genind_files/species_complex_outliers_genind.Rda")
save(species_complex_neutral_genind, file = "data/genind_files/species_complex_neutral_genind.Rda")
save(neosho_outliers_genind, file = "data/genind_files/neosho_outliers_genind.Rda")
save(neosho_neutral_genind, file = "data/genind_files/neosho_neutral_genind.Rda")
save(smallmouth_neutral_genind, file = "data/genind_files/smallmouth_neutral_genind.Rda")
```
...
##### 3c.1. Run cross validation tests on all hierarchical analyses and extract data; run the Rmd chunk below:

##### Run cross validation for DAPC:
```{r}
# Load all genind files
load("data/genind_files/all_neutral_genind.Rda")
load("data/genind_files/species_complex_outliers_genind.Rda")
load("data/genind_files/species_complex_neutral_genind.Rda")
load("data/genind_files/neosho_outliers_genind.Rda")
load("data/genind_files/neosho_neutral_genind.Rda")
load("data/genind_files/smallmouth_neutral_genind.Rda")
...
# Save all xval data
save(species_complex_outliers_xval_data, file = "data/xval_data/species_complex_outliers_xval_data.Rda")
save(species_complex_neutral_xval_data, file = "data/xval_data/species_complex_neutral_xval_data.Rda")
save(neosho_outliers_xval_data, file = "data/xval_data/neosho_outliers_xval_data.Rda")
save(neosho_neutral_xval_data, file = "data/xval_data/neosho_neutral_xval_data.Rda")
```
...
```{r}
# Load all xval data
load("data/xval_data/species_complex_outliers_xval_data.Rda")
load("data/xval_data/species_complex_neutral_xval_data.Rda")
load("data/xval_data/neosho_outliers_xval_data.Rda")
load("data/xval_data/neosho_neutral_xval_data.Rda")
...
# Save dapc files
save(species_complex_outliers_dapc, file = "data/dapc_data/species_complex_outliers_dapc.Rda")
save(species_complex_neutral_dapc, file = "data/dapc_data/species_complex_neutral_dapc.Rda")
save(neosho_outliers_dapc, file = "data/dapc_data/neosho_outliers_dapc.Rda")
save(neosho_neutral_dapc, file = "data/dapc_data/neosho_neutral_dapc.Rda")
```
...
```{r}
# Load dapc files
load("data/dapc_data/species_complex_outliers_dapc.Rda")
load("data/dapc_data/species_complex_neutral_dapc.Rda")
load("data/dapc_data/neosho_outliers_dapc.Rda")
load("data/dapc_data/neosho_neutral_dapc.Rda")
...
# Save LD data
save(species_complex_outliers_ld, file = "data/dapc_data/species_complex_outliers_ld.Rda")
save(species_complex_neutral_ld, file = "data/dapc_data/species_complex_neutral_ld.Rda")
save(neosho_outliers_ld, file = "data/dapc_data/neosho_outliers_ld.Rda")
save(neosho_neutral_ld, file = "data/dapc_data/neosho_neutral_ld.Rda")
```
...
```{r}
# Save LD data
load("data/dapc_data/species_complex_outliers_ld.Rda")
load("data/dapc_data/species_complex_neutral_ld.Rda")
load("data/dapc_data/neosho_outliers_ld.Rda")
load("data/dapc_data/neosho_neutral_ld.Rda")
...
## ------------------------ END OF ANALYSIS 6: DIRECTIONAL SELECTION INFERENCE ----------------------- ##
