...
flowchart LR
  ...
  E[analysis_directories] ---> I[figures]
  A{SMB_Genomics} --> J[raw_data]
  K(AR21_Aligned_Genotypes_stringent.vcf):::blue --> J[raw_data]
  L(metadata.xlsx):::blue --> J[raw_data]
...
### Analysis 6: Directional selection inference
...
### Analysis 7: Demographic inference
